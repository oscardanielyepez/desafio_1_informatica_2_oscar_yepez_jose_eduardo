...
int main()
{
    ...
    if (coincide) {
        ...
        cout << "Los datos de enmascaramiento NO coinciden con la imagen actual." << endl;
        // Aquí es donde deberías probar diferentes transformaciones para encontrar la correcta
    }
